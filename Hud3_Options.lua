...
local scheme = {
	root = {	'PocoHud3 Main configuration',
		...
		shieldColor = {'color','MediumSpringGreen','color','Shield lost color, full amount'},
		healthColor = {'color','Red','color','Health lost color, full amount'},
		shieldColorDepleted = {'color','Aqua','color','Shield lost color, minimum amount'},
		healthColorDepleted = {'color','Magenta','color','Health lost color, minimum amount'},
